...
import '../app_res/textStyles.dart';
...
class ChatPage extends StatefulWidget {
  final Users? peermodel;

  const ChatPage({Key? key, required this.peermodel}) : super(key: key);
...
class _ChatPageState extends State<ChatPage> {
  ...
  late String currentuserImage =
      "https://fastly.picsum.photos/id/510/200/300.jpg?hmac=u6iNoUL4S50O2eGkBF1jHRJL3Hgrbgdb258jroHPYeI";
  ...
  void readLocal() {
    ...
    FirebaseFirestore.instance
      ...
      currentuserImage = await snapshot.get('userImage');
    });
    peerId = widget.peermodel!.id;
    peerImage = widget.peermodel!.userImage;
    peerName = widget.peermodel!.name;
